...
made to extend existing detectors to estimate viewpoint along with object class detections, including the implicit
shape model~\cite{sun10eccv}, the constellation model~\cite{stark10bmvc}, and the
...
representation, termed WHO (Whitened Histogram of Orientations). This development makes it feasible to train
...
models {\em on the fly}, without the need for offline processing. We call these NZ-WHO templates \ref{fig:front}. As a
