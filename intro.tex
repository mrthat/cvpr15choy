...
models {\em on the fly}, without the need for offline processing. We call these Non-Zero Whiten Histograms of Orientations(NZ-WHO) templates \ref{fig:front}. As a
...
WHO, termed Non-Zero Whiten Histograms of Orientations(NZ-WHO), and making efficient use of the specific
