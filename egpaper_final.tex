...
\author{Christopher B. Choy, Michael Stark, Sam Corbett-Davies, Silvio Savarese\\
    Stanford University, Max Plank Institutes\\
...
to perform joint optimization on scale, translation, continuous rotation, and
