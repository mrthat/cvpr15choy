...
The condition number of of the matrix is \scream{x}, much smaller than the size
...
In this section, we validate our proposed NZ-WHO templates in two different ways. First, we make a set of NZ-WHO templates for a set of CAD models from various viewpoints. Then we run the bank of NZ-WHO templates as an ensemble of weak detectors and show that we can achieve 2D-3D matching We want to see how robust the NZ-WHO to real images
