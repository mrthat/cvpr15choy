...
\caption{Example enriched bounding boxes. Given R-CNN~\cite{Girshick14}
  ...
  reasonably. The first column shows bounding boxed produced by R-CNN detection. Subsequent columns show the output of our method given this bounding box input. Blue boxes are R-CNN output and purple boxes are
